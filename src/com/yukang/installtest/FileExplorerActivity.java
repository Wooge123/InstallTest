...
public class FileExplorerActivity extends Activity implements OnItemClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		adapter = new SimpleAdapter(this, list, R.layout.list_item, new String[] { "name", "img" },
